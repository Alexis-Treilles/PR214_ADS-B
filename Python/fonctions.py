...
cred = credentials.Certificate('PR214/PR214/PR214/Python/cred.json') 
import socket
import struct
import time
import pandas as pd
        ...
        for key, value in existing_data.items():
            ...
            if all(k in value for k in ['icao', 'latitude', 'longitude']):
                ...
                if icao == existing_icao and latitude == existing_latitude and longitude == existing_longitude:
                    ...
                    if new_data_timestamp - existing_timestamp > 30:  # Supprimer si la différence de timestamp est supérieure à 30 secondes
...
def decode_adsb(message, informations_par_icao, timestamp):  # decode d'une trame hexadécimale
    ...
    if df == 17 or df == 18:  # Trames de type ADS-B
        ...
        #print(informations_par_icao[icao_id])
