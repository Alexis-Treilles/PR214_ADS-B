...
def main():
    ...
    while True:
        ...
        hex_strings = lire_colonne_csv("PR214/PR214/PR214/log_prof.csv", "Hexadecimal")
        echs = lire_colonne_csv("PR214/PR214/PR214/log_prof.csv", "ech")
        analyse_trames_progress(hex_strings, echs)

        # Lire et traiter le deuxième fichier CSV
        hex_strings = lire_colonne_csv("PR214/PR214/PR214/frames (1).csv", "Hexadecimal")
        echs = lire_colonne_csv("PR214/PR214/PR214/frames (1).csv", "Temps")
        #analyse_trames_progress(hex_strings, echs)
